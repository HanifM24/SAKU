...
//    }
    ...
    @GetMapping("/getNeracaExcel/{tgl_trx}")
    public ResponseEntity<Resource> listDataNeracaVarExcel(@PathVariable String tgl_trx) throws IOException {
        ...
        String pathinput = s + "/SAKU/src/main/resources/static/view/ExcelTemplate/NeracaExcelTemplate.xlsx";
        System.out.println("Current absolute path is: " + pathinput);
...
//        FileInputStream file = new FileInputStream(new File("C:/Users/Hanif Muhammad/Downloads/NeracaExcelTemplate.xlsx"));
            FileInputStream file = new FileInputStream(String.valueOf(pathinput));
            ...
            int u = 0;
            Double total;
            String currentyear = tgl_trx.substring(0, 4);
//        Row Boldrow = sheet.getRow(3);
//        Cell Boldcell = Boldrow.getCell(2);
            CellStyle boldstyle = null;

            Row rowyear = sheet.getRow(2);
            rowyear.getCell(1).setCellValue("Year " + currentyear);


//        rowyear.getCell(1).setCellValue(getNeracaModels.get(i).getNOCOA());
            ...
            for (int k = 1; k < 4; k++) {
                ...
                if (k == 1) {
                    boldstyle = rowheader.getCell(2).getCellStyle();
                }
                rowheader.getCell(2).setCellStyle(boldstyle);
                ...
                rowtotal.getCell(2).setCellStyle(boldstyle);
...
//        Path path = Paths.get("C:/Users/Hanif Muhammad/Documents/SAKU/SAKU/src/main/resources/static/view/DOC/NeracaExcelTemplate" + time + ".xlsx");
            String outputpath = s + "\\SAKU\\src\\main\\resources\\static\\view\\DOC\\NeracaExcelTemplate" + time + ".xlsx";
...
//        try {
            ...
            Path s1 = Paths.get(currentRelativePath1.toAbsolutePath() + "\\SAKU\\src\\main\\resources\\static\\view\\DOC\\NeracaExcelTemplate" + time + ".xlsx");

//            String Outputfileresult =  "C:\\Users/Hanif%20Muhammad/Documents/SAKU/SAKU/src/main/resources/static/view/DOC/NeracaExcelTemplate" + time + ".xlsx";
//            boolean testt = new File(Outputfileresult).exists();
//            URL pathoitputt = new URL(Outputfileresult);
//        try {
            Resource resource = new UrlResource(s1.toUri());
            ...
            if(resource.exists())
            {
                ...
                byte [] data = Files.readAllBytes(s1.toRealPath());
...
//    @GetMapping("/getProfitLossExcel/{tgl_trx}")
//    public ResponseEntity<Resource> listDataProfitLossVarExcel(@PathVariable String tgl_trx) throws IOException {
//        FileInputStream file = new FileInputStream(new File("C:/Users/Hanif Muhammad/Downloads/NeracaExcelTemplate.xlsx"));
//        Workbook woorkbook =  new XSSFWorkbook(file);
//        Sheet sheet = woorkbook.getSheetAt(0);
//
